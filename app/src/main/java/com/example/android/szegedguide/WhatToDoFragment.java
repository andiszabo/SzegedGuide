...
public class WhatToDoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final String[] attractionNames = getResources().getStringArray(R.array.list_what_to_do_names);
        final String[] attractionAddresses = getResources().getStringArray(R.array.list_what_to_do_addresses);
        final String[] attractionOpeningHours = getResources().getStringArray(R.array.list_what_to_do_opening_hours);
        final TypedArray attractionImages = getResources().obtainTypedArray(R.array.list_what_to_do_images);
