...
public class WhereToStayFragment extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final String[] accomodationNames = getResources().getStringArray(R.array.list_where_to_stay_names);
        final String[] accomodationAddresses = getResources().getStringArray(R.array.list_where_to_stay_addresses);
        final String[] accomodationOpeningHours = getResources().getStringArray(R.array.list_where_to_stay_opening_hours);
        final TypedArray accomodationImages = getResources().obtainTypedArray(R.array.list_where_to_stay_images);
