...
public class LocalAttractionAdapter  extends ArrayAdapter<LocalAttraction> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView localAttractionNameTextView = (TextView) listItemView.findViewById(R.id.attraction_name);
        localAttractionNameTextView.setText(currentLocalAttraction.getLocalAttractionName());

        TextView localAttractionAddressTextView = (TextView) listItemView.findViewById(R.id.attraction_address);
        localAttractionAddressTextView.setText(currentLocalAttraction.getLocalAttractionAddress());

        TextView localAttractionOpeningHoursTextView = (TextView) listItemView.findViewById(R.id.attraction_opening_hours);
