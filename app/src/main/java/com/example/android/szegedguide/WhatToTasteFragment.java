...
public class WhatToTasteFragment extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final String[] restaurantNames = getResources().getStringArray(R.array.list_what_to_taste_names);
        final String[] restaurantAddresses = getResources().getStringArray(R.array.list_what_to_taste_addresses);
        final String[] restaurantOpeningHours = getResources().getStringArray(R.array.list_what_to_taste_opening_hours);
        final TypedArray restaurantImages = getResources().obtainTypedArray(R.array.list_what_to_taste_images);
